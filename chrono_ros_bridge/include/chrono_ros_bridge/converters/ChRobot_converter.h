...
#include "chrono_ros_msgs/msg/ch_robot.hpp"
 ...
 *
 * In the case of ChRobot, the message structure will look like the following:
 * {
 * 	type: ChRobot
 * 	name: vehicle
 * 	data: {
 ...
 */
SerializedMessagePtr ChRobot_converter(chrono::utils::ChJSONReader& reader) {
    std::string type, id;
    ...
    chrono_ros_msgs::msg::ChRobot msg;
